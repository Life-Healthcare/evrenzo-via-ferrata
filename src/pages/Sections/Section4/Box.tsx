...
export default ({children, className, title, image}: BoxProps) => {
    ...
    return (
        <>
            ...
            className={`flex flex-col p-32 gap-5 text-black ${image ? image : 'before:bg-white'} absolute z-50 top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 w-[1418px] h-[1180px] border-bottom-right-cut-sm`}>
