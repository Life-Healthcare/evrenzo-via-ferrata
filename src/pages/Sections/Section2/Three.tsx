        ...
        className="absolute flex flex-col w-full h-full bg-cover bg-fixed bg-center text-gray-700 p-24 pb-12 text-center">
            ...
            <section className="grid grid-cols-5 text-[32px] text-start gap-20">
                <div className="flex flex-col gap-5 col-span-2">
                    <p>When low oxygen (hypoxia) is detected, the carotid body communicates rapidly with the brain to raise the respiratory rate.<SmallText>1</SmallText></p>
                    <p>In the longer term, the body adapts physiologically to hypoxia by raising levels of erythropoietin (EPO), which increases red blood cell production (erythropoiesis). But how this process itself is controlled has been a mystery.<SmallText>1</SmallText></p>
                ...
                <div className="flex flex-col gap-5 col-span-3">
                    <h2 className="text-4xl font-bold-ext">How the threads came together<SmallText>1</SmallText></h2>
                        ...
                        <AnimateSharedLayout>
                            <currentBoxContext.Provider value={[currentBox, setCurrentBox]}>
                                <Box className="before:bg-green-700" title="EPO Gene" line="bottom">
                                    Professor Gregg Semenza found that specific DNA segments located next to the EPO gene mediated the response to hypoxia.<SmallText>1</SmallText>
                                </Box>
                                <Box className=" before:bg-[#ad1aac]" title="O2 sensing mechanism" line="bottom">
                                    Professor Semenza’s group discovered how the EPO gene is regulated by varying O2 levels, and Sir Peter Ratcliffe’s group found that this mechanism is functional in many different cell types (not only in the kidney).<SmallText>1</SmallText>
                                </Box>
