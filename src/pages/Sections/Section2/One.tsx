            ...
            <header className="flex">
                ...
                <div className="flex flex-grow justify-center mt-14">
                    <div className="flex flex-col gap-7 w-[800px] translate-x-[calc(-396px/2)]">
                        ...
                        Turkey, Russia, <br/> South Africa, Egypt, UAE and Kuwait.
                        </p>
                    </div>
                </div>
            </header>
            <section className="flex flex-col flex-grow justify-center items-center gap-24">
                <h1 className="text-7xl w-[800px] text-gray-700">A Nobel Prize winning discovery</h1>
                <ButtonStart onClick={() => navigate("/2/2")}/>
            </section>
            <ScreensaverFooter/>
        </motion.article>
    )
