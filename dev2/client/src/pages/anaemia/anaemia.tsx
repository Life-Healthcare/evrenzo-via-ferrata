        ...
        <Left>
          <Animation>
            <p>
              ...
              far-ranging implications for human physiology, disease states, and
              medicine.<sup>1</sup>
            </p>
            <p>
            ...
            <p>
              The HIF pathway is therefore a target for new treatments to manage
              anaemia of CKD.
            </p>
          </Animation>
          <Animation className="bold">
            <p>
              To find out how patients with anaemia of CKD are benefiting from a
              new class of treatment, take the next step on the EVRENZO Via
              Ferrata.
            </p>
          </Animation>
          <Animation className="smaller">
            <p>
              <ul>
                ...
                <li>
                  4. Babitt JL, Lin HY. J Am Soc Nephrol. 2012;(10)23:1631-1634.
                </li>
                <li>
                  5. Peyssonnaux C, Nizet V, Johnson RS. Cell ycle. 2008;
                  (1)7:28-32.
                </li>
                <li>
